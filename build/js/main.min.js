...
var menuOverlay = document.querySelector('.main-header__menu-overlay');
document.querySelectorAll('.nojs').forEach(function (item) {
  return item.classList.remove('nojs');
});
var changesMenu = function changesMenu() {
  var logoImg = document.querySelector('.main-header__logo');
...
var removeIsActive = function removeIsActive() {
  var activeItems = document.querySelectorAll('.is-active');
...
var closeMenuLink = function closeMenuLink() {
